...
const FeaturedProject:React.FC<FeaturedProjectProps> = ({
  ...
  return (
    <article className="w-full grid xl:flex items-center justify-between rounded-3xl
    border border-solid border-dark dark:border-light bg-light dark:bg-dark 
    shadow-2xl p-3 md:p-6 xl:p-12 my-6 lg:my-12">
        <Image 
          src={img}
          alt={title}
          className="w-full xl:w-1/2 overflow-hidden h-auto rounded-lg"
        />

      <div className="w-full xl:w-1/2 my-6 flex flex-col items-start justify-between xl:pl-6">
